#' @title Lay out more than one plot on a page 
#' @export
#'
#' @description CREDIT: this function is taken from the Cookbook for R
...
#'
#' @param cols number of columns in layout @param layout a matrix specifying
